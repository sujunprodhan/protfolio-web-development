    ...
    <div>
      <section className=" flex items-center px-6">
        <div className=" min-h-screen w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 space-y-5 items-center">
          {/* Left Content */}
          <div>
            <h4 className="mb-2 text-gray-600">WELCOME TO MY WORLD</h4>
            <div className="flex flex-col">
              ...
              <div>
                <h2 className="text-3xl md:text-3xl text-gray-600 font-semibold">
                  a <span className=" text-gray-600 font-semibold">{text}</span>
            ...
            <div>
              <div className="flex justify-between mt-10">
                <div>
                  <h2 className="text-xl text-gray-600 mb-3">Find Me</h2>
                  <div>
                    <div className="flex gap-5 items-center">
                      <Link href={'https://www.facebook.com/sujon.prodhan.146'}>
                        <span className=" h-10 w-10 bg-gray-600 bg-opacity-25 text-gray-400 text-xl inline-flex items-center justify-center rounded-md shadow-shadowOne hover:bg-opacity-40 hover:translate-y-1 transition-all hover:text-designColor cursor-pointer duration-300">
                ...
                {/* Skill Section */}
                <div>
                  <h2 className="text-xl text-gray-600 mb-3">Best Skill On</h2>
                  {/* Skill Icon section */}
          ...
          <section>
            <div className="flex justify-center p-5 items-center relative">
              ...
              />
              <div className="absolute bottom-0 w-125 h-125 bg-linear-to-r from-[#le2024] to-[#202327] flex justify-center items-center rounded-md shadow-2xl"></div>
            </div>
          </section>
        </div>
      </section>
